      ...
      <div id="footer" className="w-full ">
        <div className="mt-1 w-full  md:pr-0 mb:pb-0 md:pl-0">
          <div id="homeFooter" className="pt-5 w-full bg-black gap-2">
            ...
            <div className="text-text_Quaternary1 flex lg:flex-row flex-col items-center justify-center px-10 lg:px-20 gap-3">
              <img src={assets.gaming1} alt="" />
              <p className="text-sm">
                {settings.siteTitle} is a limited liability company incorporated
                under the laws of Curacao Players are requested not to contact
                any untrusted sources for {settings.siteTitle} accounts as this
                is an online site and they can only register independently
                without any agents. Only deposit through the account details
                generated by the system or provided by our official support
                team.
              </p>
            </div>
            <div
...
"
            ...
            <hr className="pb-5 border-gray-800" />
            <div className="w-full flex items-center justify-center pb-20 ">
              <p className="text-gray-500 text-sm">
                Rules & Regulations 2016-2022 v. 5.71
              </p>
            </div>
          </div>
        </div>
