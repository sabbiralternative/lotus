          ...
          >
            ...
            >
              <div title="loginFormMonileUserIdInput" className="w-full">
                <div className="flex w-full items-center py-3.5 bg-transparent border border-t-0 border-r-0 border-l-0 bg-border">
                  <input
            ...
            {settings.registration && (
              <div
                ...
                className="w-full flex justify-center items-center text-xs md:text-sm lg:text-base text-text_Quaternary1"
              >
                <div>
                  New User?{" "}
                  <span
                    ...
                    className="text-text_Quaternary1 cursor-pointer"
                  >
                    Create an account
                  </span>
                </div>
